...
namespace EMIC2.Models
{
    ...
    public partial class DSP_THBBOBEALTINFO
    {
        public int THBBOBEALTINFO_ID { get; set; }
        public Nullable<int> THBBOBEALT_ID { get; set; }
        ...
        public string CMAMtext { get; set; }
        public string ROADCLOSE_TYPE { get; set; }
