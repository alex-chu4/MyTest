...
using EMIC2.Models.Interface.ERA2.ERA2030102;
using EMIC2.Result;
...
namespace EMIC2.Models.Dao.ERA.ERA2030102
{
    public class ERA2030102Dao : IERA2030102Dao
    {
        /// <summary>
        /// 查詢通報表A2
        /// </summary>
        /// <returns> ERA2030102Dto</returns>
        public List<ERA2030102Dto> ERA2_QRY_MAX_D3(ERA2030102SearchModelDto data)
        {
            List<ERA2030102Dto> result = new List<ERA2030102Dto>();
            using (var conn = new SqlConnection(DBHelper.GetEMIC2DBConnection()))
            {
                ...
                result = conn.Query<ERA2030102Dto>(sql, parameters).ToList();
        ...
        /// </summary>
        /// <returns> ERA2030102Dto</returns>
        public List<ERA2030102Dto> ERA2_QRY_MAX_D3a(ERA2030102SearchModelDto data)
        {
            List<ERA2030102Dto> result = new List<ERA2030102Dto>();
            using (var conn = new SqlConnection(DBHelper.GetEMIC2DBConnection()))
            {
        ...
        public IResult ImportRptToDisp(ERA2030102SearchModelDto data)
        {
