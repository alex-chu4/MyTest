...
using EMIC2.Models.Dao.Dto.ERA.ERA2030109;
using EMIC2.Models.Helper;
using EMIC2.Models.Interface.ERA2.ERA2030109;
using EMIC2.Result;
...
namespace EMIC2.Models.Dao.ERA.ERA2030109
{
    public class ERA2030109Dao : IERA2030109Dao
    {
        /// <summary>
        /// 查詢通報表A2
        /// </summary>
        /// <returns> ERA2030109Dto</returns>
        public List<ERA2030109Dto> ERA2_QRY_MAX_C4(ERA2030109SearchModelDto data)
        {
            List<ERA2030109Dto> result = new List<ERA2030109Dto>();
            using (var conn = new SqlConnection(DBHelper.GetEMIC2DBConnection()))
            {
                string sql =
                    @"SELECT  
                              ERA_C4.CITY_NAME         AS       CITY_NAME        
                             ,ERA_C4.AMBER_RIVERS      AS       AMBER_RIVERS     
                             ,ERA_C4.AMBER_TOWNSHIP    AS       AMBER_TOWNSHIP    
                             ,ERA_C4.AMBER_VILLAGE     AS       AMBER_VILLAGE    
                             ,ERA_C4.RED_RIVERS	       AS       RED_RIVERS    
                             ,ERA_C4.RED_TOWNSHIP      AS       RED_TOWNSHIP    
                             ,ERA_C4.RED_VILLAGE       AS       RED_VILLAGE    
                             ,ERA_C4.TOTAL	           AS       C4_TOTAL         
                             ,ERA_C4.STATUS	           AS       STATUS_C4         
							 ,ERA_C4.SHOW_ORDER        AS       SHOW_ORDER	      
                      FROM ERA2_QRY_MAX_C4 (@P_EOC_ID, @P_PRJ_NO, @P_RPT_MAIN_ID) AS ERA_C4
                ...
                result = conn.Query<ERA2030109Dto>(sql, parameters).ToList();
        ...
        public IResult ImportRptToDisp(ERA2030109SearchModelDto data)
        {
