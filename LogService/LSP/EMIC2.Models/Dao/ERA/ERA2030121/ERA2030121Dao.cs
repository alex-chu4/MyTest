...
using EMIC2.Models.Dao.Dto.ERA.ERA2030121;
using EMIC2.Models.Helper;
using EMIC2.Models.Interface.ERA2.ERA2030121;
using EMIC2.Result;
...
namespace EMIC2.Models.Dao.ERA.ERA2030121
{
    public class ERA2030121Dao : IERA2030121Dao
    {
        /// <summary>
        /// 查詢通報表A2
        /// </summary>
        /// <returns> ERA2030121Dto</returns>
        public List<ERA2030121Dto> ERA2_QRY_MAX_F32(ERA2030121SearchModelDto data)
        {
            List<ERA2030121Dto> result = new List<ERA2030121Dto>();
            using (var conn = new SqlConnection(DBHelper.GetEMIC2DBConnection()))
            {
                string sql =
                    @"SELECT 
                                 ERA_F32.DELAY_DATETIME		  AS    STOP_TIME
                                ,ERA_F32.AIRLINE			  AS    AIRLINE
                                ,ERA_F32.FLIGHT				  AS    ROUTE_SERVICE
                                ,ERA_F32.DELAY_GROUNDING	  AS    AIR_STATUS
                                ,ERA_F32.DELAY_REASON		  AS    REASON
                                ,ERA_F32.REMARK				  AS    REMARK
                      FROM ERA2_QRY_MAX_F32 (@P_EOC_ID, @P_PRJ_NO, @P_RPT_MAIN_ID) AS ERA_F32 
                ...
                result = conn.Query<ERA2030121Dto>(sql, parameters).ToList();
        ...
        public IResult ImportRptToDisp(ERA2030121SearchModelDto data)
        {
