...
namespace EMIC2.Models
{
    ...
    public partial class ERA2_RPT_C3
    {
        public int RPT_DETAIL_ID { get; set; }
        public int RPT_MAIN_ID { get; set; }
        public string REFUGE_CITY { get; set; }
        public string LOCATION { get; set; }
        public Nullable<int> BOATS { get; set; }
        public Nullable<int> SAILORS { get; set; }
        public Nullable<int> SAILORS_ONBOAT { get; set; }
        public Nullable<int> SAILORS_ONSHORE { get; set; }
