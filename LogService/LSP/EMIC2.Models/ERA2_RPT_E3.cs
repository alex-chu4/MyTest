...
namespace EMIC2.Models
{
    ...
    public partial class ERA2_RPT_E3
    {
        ...
        public Nullable<int> RECVY_BUDGET { get; set; }
        public Nullable<int> BUSINESS_LOST { get; set; }
        public Nullable<int> OTHERS_LOST { get; set; }
